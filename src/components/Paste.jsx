    ...
    <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-3">
        ...
        <div className="flex flex-col border border-[rgba(128,121,121,0.3)] py-4 rounded-[0.4rem]">
          <h2 className="px-4 text-4xl font-bold border-b border-[rgba(128,121,121,0.3)] pb-4 text-blue-500">
            All Pastes
          </h2>
              ...
              filteredPastes.map((paste) => (
                ...
                >
                  ...
                  <div className="w-[50%] flex flex-col space-y-3">
                    ...
                    <p className="text-sm font-normal line-clamp-3 max-w-[80%] text-white">
                      {paste?.content}
                    </p>
                  </div>

                  {/* icons */}
                  <div className="flex flex-col gap-y-4 sm:items-end text-white">
                    <div className="flex gap-2 flex-wrap sm:flex-nowrap">
                      <button
                        className="text-white p-2 rounded-[0.2rem] bg-white border border-[#c7c7c7]  hover:bg-transparent group hover:border-blue-500"

      ...
      <div className="flex flex-col gap-y-5 items-start">
        <div className="w-full flex flex-row gap-x-4 justify-between items-center">
          <input
            ...
            className={`${
              pasteId ? "w-[80%]" : "w-[85%]"
            } text-black border border-input rounded-md p-2 bg-zinc-800 text-white`}
          />
          <button
        ...
        >
          ...
          >
            ...
            >
              {/*Copy  button */}
              <button
                className={`flex text-white justify-center items-center  transition-all duration-300 ease-in-out group`}
                onClick={() => {
          ...
          <textarea
            ...
            className="w-full p-3  focus-visible:ring-0 bg-zinc-800 text-white"
            style={{
              caretColor: "#000",
            }}
            rows={20}
